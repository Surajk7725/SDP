import Header from './AddProject1';
import Tasks from './AddProject3';
...
function App() {
    // All States
    const [loading, setloading] = useState(true); // Pre-loader before page rendersAS
    ...
    const editTask = (id) => {
        ...
        const date = prompt("Starting Date & Ending Date");
        ...
        <>
            {
                loading ?
                    ...
                    <div className="container">
                        ...
                        {/* Task Counter */}
                        <h3>Number of Projects: {tasks.length}</h3>
                        {/* Displaying of Tasks */}
                        {
                            tasks.length > 0 ?
